...
!---
  ...
  use constants, only: NR_DENSITY,N_SLS, &
    ...
    GLL_REFERENCE_MODEL, & !USE_1D_REFERENCE, & !KTAO: USE_1D_REFERENCE is moved into Par_file
...
! main parameter module for specfem simulations
  ...
  use constants, only: myrank,CUSTOM_REAL,IMAIN,ISTANDARD_OUTPUT,IOUT,OUTPUT_FILES_BASE, &
    ...
    GRAVITY_INTEGRALS, &
    SUPPRESS_CRUSTAL_MESH, & ! SUPPRESS_MOHO_STRETCHING,SUPPRESS_INTERNAL_TOPOGRAPHY, & !KTAO moved into shared_parameters 
