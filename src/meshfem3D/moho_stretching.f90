...
! stretches the moho according to the crustal variations (CRUST1.0, CRUST2.0, ..)
  ...
  use constants, only: myrank, &
    ...
    ICRUST_CRUST_SH,ICRUST_SGLOBECRUST, & !KTAO: SUPPRESS_MOHO_STRETCHING,ICRUST_CRUST_SH,ICRUST_SGLOBECRUST, &
  ...
  use shared_parameters, only: REGIONAL_MESH_CUTOFF, USE_LOCAL_MESH, SUPPRESS_MOHO_STRETCHING !KTAO add
