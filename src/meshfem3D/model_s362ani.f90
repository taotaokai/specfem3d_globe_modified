...
subroutine evradker(depth,kerstr,nker,vercof,dvercof,ierror, upper_650, lower_650)
   ...
   logical, intent(in) :: upper_650
   logical, intent(in) :: lower_650
...
subroutine model_s362ani_subshsv(xcolat,xlon,xrad,dvsh,dvsv,dvph,dvpv, upper_650, lower_650)
   ...
   logical, intent(in) :: upper_650, lower_650 !KTAO add
   ...
   call evradker (depth,kerstr,numker,vercof,vercofd,ierror, upper_650, lower_650)
