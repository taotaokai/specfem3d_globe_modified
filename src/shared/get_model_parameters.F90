...
!
  ...
  !KTAO add
  use shared_parameters, only: &
    USER_MAX_RATIO_CRUST_STRETCHING, USER_RMOHO_STRETCH_ADJUSTMENT, USER_R80_STRETCH_ADJUSTMENT, &
    USER_SUPPRESS_INTERNAL_TOPOGRAPHY, USER_SUPPRESS_MOHO_STRETCHING 
...
!       this will be done in routine broadcast_computed_parameters().
  ...
  if (USER_RMOHO_STRETCH_ADJUSTMENT /= 999999.d0) then
    write(IMAIN,*) 'KTAO: USER_RMOHO_STRETCH_ADJUSTMENT = ', USER_RMOHO_STRETCH_ADJUSTMENT
    RMOHO_STRETCH_ADJUSTMENT = USER_RMOHO_STRETCH_ADJUSTMENT
  endif
  if (USER_R80_STRETCH_ADJUSTMENT /= 999999.d0) then
    write(IMAIN,*) 'KTAO: USER_R80_STRETCH_ADJUSTMENT = ', USER_R80_STRETCH_ADJUSTMENT
    R80_STRETCH_ADJUSTMENT = USER_R80_STRETCH_ADJUSTMENT
  endif
  SUPPRESS_MOHO_STRETCHING = USER_SUPPRESS_MOHO_STRETCHING
  write(IMAIN,*) 'KTAO: USER_SUPPRESS_MOHO_STRETCHING = ', USER_SUPPRESS_MOHO_STRETCHING
  SUPPRESS_INTERNAL_TOPOGRAPHY = USER_SUPPRESS_INTERNAL_TOPOGRAPHY
  write(IMAIN,*) 'KTAO: USER_SUPPRESS_INTERNAL_TOPOGRAPHY = ', USER_SUPPRESS_INTERNAL_TOPOGRAPHY
