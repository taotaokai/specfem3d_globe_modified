...
! holds input parameters given in DATA/Par_file
  ...
  logical :: USE_ECEF_COORDINATE = .false. !! KTAO: (optional) source location in ECEF x,y,z 
  ...
  ! (optional) mesh stretching parameters !KTAO add
  ...
  logical :: USER_SUPPRESS_MOHO_STRETCHING = .false.
  logical :: USER_SUPPRESS_INTERNAL_TOPOGRAPHY = .false.
